...
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //tauros add pageWidth
//        final float pageWidth;
//        if (getWidth() / (1f * count) - paddingLeft - getPaddingRight() > 0) {
//            pageWidth = getWidth() / (1f * count) - paddingLeft - getPaddingRight();
//        } else {
//            pageWidth = 1f;
//        }
        final float left = paddingLeft + pageWidth * (mCurrentPage + mPositionOffset);
        //tauros add left
//        final float left = paddingLeft + (getWidth() / (1f * count)) * (mCurrentPage + mPositionOffset);
