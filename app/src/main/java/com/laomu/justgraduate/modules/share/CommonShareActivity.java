package com.laomu.justgraduate.modules.share;
...
public class CommonShareActivity extends BaseActivity implements IWXAPIEventHandler {
	...
	private String mTitleContent = CommonDefine.SNS_SHARE_BUNDLE_MSG;;
	...
	public View CreateView() {
		...
		mSNSShareMenu.setCloseListener(new SNSShareMenu.CloseShareViewListener() {
