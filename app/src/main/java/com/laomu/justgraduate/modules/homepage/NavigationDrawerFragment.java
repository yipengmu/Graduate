...
public class NavigationDrawerFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tv_kaoyanliuxue;
    private TextView tv_search_school;
    private TextView tv_school_food;
    private TextView tv_brother_tell;
    private TextView tv_weddingbirth;
...
//                R.layout.jg_drawer_common_item,
//                android.R.id.text1,
//                CommonDefine.DRAWER_STRING_LIST_CONTENT));
...
//        return mDrawerListView;
    ...
    private void findViews(LinearLayout rootView) {
        ...
        tv_indurstry = (TextView) rootView.findViewById(R.id.tv_indurstry);
        tv_kaoyanliuxue = (TextView) rootView.findViewById(R.id.tv_kaoyanliuxue);
        tv_weddingbirth = (TextView) rootView.findViewById(R.id.tv_weddingbirth);
        tv_search_school = (TextView) rootView.findViewById(R.id.tv_search_school);
        ...
        tv_indurstry.setOnClickListener(this);
        tv_kaoyanliuxue.setOnClickListener(this);
        tv_weddingbirth.setOnClickListener(this);
...
//        }
    ...
    public static interface NavigationDrawerCallbacks {
         ...
         */
        void onNavigationDrawerItemSelected(String pageName);
    }
}
