package com.laomu.justgraduate.common.custormviews;
...
public class JGTabbarView extends LinearLayout {
    ...
    public JGTabbarView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
    ...
    public JGTabbarView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public JGTabbarView(Context context) {
        super(context);
        init(context);
    }
